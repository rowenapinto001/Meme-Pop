...
const BACKGROUND_VALID_THEMES = ["random", "office", "coding", "studying", "gaming"];
...
function normalizeBackgroundSettings(raw) {
    ...
    const intervalSeconds = raw?.intervalSeconds && BACKGROUND_VALID_INTERVALS.includes(raw.intervalSeconds)
        ? raw.intervalSeconds
